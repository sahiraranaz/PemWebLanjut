                            ...
                            <div class="card-body">
                                <form action="/user/update/{{$users->id}}" method="post" enctype="multipart/form-data">  
                                    ...
                                    <div class="form-group">                 
                                                ...
                                                <input type="file" class="form-control" required="required" name="image" value="{{$users->profile}}"></br>
                                                <img width="150px" src="{{asset('/storage/'.$users->profile)}}">
                                            </div>                         
                                    <button type="submit" name="edituser" class="btn btn-primary float-right">Update User</button>    
                                </form>
                                </div>
                            </div>
                        </div>
