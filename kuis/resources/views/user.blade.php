...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Manage User</a>
        ...
        <section class="about-section text-center" id="about">
            <div class="container">
                <div class="row">
                    ...
                    <h1 class="text-white mb-4">List User</h1><br><br>
                    <div class="col-md-12 mb-5 mb-md-10">
                    <a href="/user/add" class="btn btn-primary" style="background-color:#64a19d">Add Data</a>
                    <a href="/user/cetakUser_pdf" class="btn btn-primary"target="_blank" style="background-color:#7952b3">Cetak PDF</a>
                </div></div>
                </div>
            ...
            <div class="container">
                ...
                <tbody>          
                        ...
                        <tr>               
                            ...
                            <td>{{$a->roles}}</td>            
                            <td>{{$a->created_at}}</td> 
                            <td><img height="80px" src="{{'storage/'.$a->profile}}"></td> 
                            <td><a href="user/edit/{{ $a->id }}" class="badge badge-warning">Edit</a>
                            <a href="user/delete/{{ $a->id }}" class="badge badge-danger">Delete</a></td>   
                        </tr>
                        @endforeach
                </tbody> 
            </table>
