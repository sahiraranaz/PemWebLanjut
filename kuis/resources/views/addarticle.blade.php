...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="about-section text-center" id="about" style="background-color:#343a40">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-white text-center">
                    <h1 class="text-white mb-4">Add Article</h1><br><br>
                    <a href="/user" class="btn btn-primary" style="background-color:#64a19d">Back</a><br><br><br></div>
        ...
        <!-- Contact-->
        @can('user-display')
        <section class="signup-section" id="search" style="background-color:#343a40">
            <div class="container">
                <div class="row">
