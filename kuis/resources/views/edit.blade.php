        ...
        <section class="about-section text-center" id="about">
            <div class="container">
                <div class="row">
                    ...
                    <h1 class="text-white mb-4">Edit Article</h1><br>
                    </div>
                </div>
        ...
        <section class="signup-section" style="background-color:#343a40">
            <div class="container">
                <div class="row">
                  ...
                  <form action="/article/update/{{$films->id}}" method="post" enctype="multipart/form-data">  
                      @csrf
                      <div class="form-group">                 
                          <label for="title">Title</label>                 
                          <input type="text" class="form-control" required="required" name="title" value="{{$films->title}}"></br>             
                      </div>
                      <div class="form-group">                 
                          <label for="trailer">Trailer</label>                 
                          <input type="text" class="form-control" required="required" name="trailer" value="{{$films->trailer}}"></br>             
                      </div>                
                      <div class="form-group">                 
                          <label for="content">Content</label>                 
                          <input type="text" class="form-control" required="required" name="content" value="{{$films->content}}"></br>             
                      </div>             
                      <div class="form-group">                 
                          <label for="image">Feature Image</label>                 
                          <input type="file" class="form-control" required="required" name="image" value="{{$films->featured_image}}"></br>
                          <img width="150px" src="{{asset('storage/'.$films->featured_image)}}">
                      </div>         
