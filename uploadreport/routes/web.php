...
Route::get('/user', 'ArticleController@user')->name('user'); 
Route::get('/user/add','ArticleController@adduser');
Route::post('/user/create','ArticleController@createuser')->name('createuser');
Route::get('/user/edit/{id}','ArticleController@edituser');
Route::post('/user/update/{id}','ArticleController@updateuser'); 
Route::get('/user/delete/{id}','ArticleController@deleteuser'); 
